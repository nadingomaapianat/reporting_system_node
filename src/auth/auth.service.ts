...
const MAIN_BACKEND_URL = requireEnv('MAIN_BACKEND_URL', 'NEXT_PUBLIC_NODE_API_URL');
...
const ORIGIN_FOR_MAIN_BACKEND = requireEnv('IFRAME_MAIN_ORIGIN', 'MAIN_APP_ORIGIN');
