...
export class GrcDashboardController {
  ...
  async getControlsByQuarter(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByQuarter(req.user, quarter, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByDepartment(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByDepartment(req.user, department, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByType(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByType(req.user, type, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByLevel(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByLevel(req.user, level, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByFrequency(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByFrequency(req.user, frequency, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByRiskResponse(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByRiskResponse(req.user, riskResponse, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByAntiFraud(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByAntiFraud(req.user, antiFraud, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByIcofrStatus(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByIcofrStatus(req.user, icofrStatus, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getFocusPointsByPrinciple(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getFocusPointsByPrinciple(req.user, principle, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByComponent(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByComponent(req.user, component, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getFocusPointsByComponent(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getFocusPointsByComponent(req.user, component, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getActionPlansByStatus(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getActionPlansByStatus(req.user, status, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByProcessAndKeyControl(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByProcessAndKeyControl(req.user, process, keyControl, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByBusinessUnitAndKeyControl(
    ...
    const ob = orderByFunctionFromRequest(req);
    return sortPaginatedResponseIfNeeded(
      await this.grcDashboardService.getControlsByBusinessUnitAndKeyControl(req.user, businessUnit, keyControl, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
      ob,
    );
  }
  ...
  async getControlsByAssertion(
    ...
    try {
      ...
      const ob = orderByFunctionFromRequest(req);
      return sortPaginatedResponseIfNeeded(
        await this.grcDashboardService.getControlsByAssertion(req.user, assertionName, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
        ob,
      );
    } catch (error: any) {
  ...
  async getControlsByComponentAndIcofrStatus(
    ...
    try {
      ...
      const ob = orderByFunctionFromRequest(req);
      return sortPaginatedResponseIfNeeded(
        await this.grcDashboardService.getControlsByComponentAndIcofrStatus(req.user, component, icofrStatus, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
        ob,
      );
    } catch (error: any) {
  ...
  async getControlsByFunctionQuarterYear(
    ...
    try {
      ...
      const ob = orderByFunctionFromRequest(req);
      return sortPaginatedResponseIfNeeded(
        await this.grcDashboardService.getControlsByFunctionQuarterYear(req.user, functionName, Number(quarter), Number(year), columnType, page, limit, startDate, endDate, parseGrcFunctionIdsFromQueries(functionId, functionIds)),
        ob,
      );
    } catch (error: any) {
